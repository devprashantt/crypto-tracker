...
import 'package:my_project13/screens/wallet_screen.dart';
import 'package:my_project13/database/coin_data.dart';
...
class _HomeScreenState extends State<HomeScreen> {
              ...
              child: Column(
                children: [
                  _listCryptoItem(
                    ...
                    myBalance: '\$ 5.441',
                    myProfit: isWaiting ? 'Loading' : coinValues['BTC'].toString(),
                    precent: 4.32,
                  ),
                  _listCryptoItem(
                    iconUrl:
                    ...
                    myBalance: '\$ 401',
                    myProfit: isWaiting ? 'Loading' : coinValues['ETH'].toString(),
                    precent: 3.97,
                  ),
                  _listCryptoItem(
                    iconUrl:
                    ...
                    myBalance: '\$ 0.45',
                    myProfit: isWaiting ? 'Loading' : coinValues['XRP'].toString(),
                    precent: -13.55,
                  ),
                ],
              ),
  ...
  Widget _cardWalletBalance(BuildContext context,
      {String ? total, totalCrypto, double ? percent}) {
    return Padding(
